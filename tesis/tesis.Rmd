...
0. Portada. Y ver si hay que poner la hojita de disclosure (seguro sí) y ver si dice lo mismo que las tesis de lic.

1. dedicatoria y agradecimientos cursis.

2. Prólogo. 
Algún debraye sobre el análisis de datos? sobre los chingos de datos? sobre educación? mates?
sobre lo importante que es en este mundo jodido que los datos hablen.
conseguir epígrafe chido sobre.... chance el típico de lots of data does not equal lots of knowledge.

3. Introducción
--------------- 

De qué habla la tesis? Qué hice? Quién es Nadro? Qué problema quiero resolver?

- ch1 Nadro y lo que hacen. 
- ch2 La base.
- ch3 Limpieza d datos. Sí, creo que amerita todo un capítulo.
- ch4 Qué hicimos? Cómo lo implementamos? Modelos. Market Basket. Lo que salga.
- ch 5 Discusión de resultados. Qué salió? Cosas de performance? Cosas mejorables.
- ch 6 Conclusiones. Relevancia de mi trabajo. Del análisis de datos. 
          De la limpieza y preparación de datos.
          Interdisciplinariedad? 
          Chance algo como lo que decían david y adolfo sobre el perfil de la gente que puede hacer esto. No sólo que sepas lo técnico sino que puedas comunicarlo y venderlo. Chance algo sobre la industria.
- ch 7 Referencias. 




NOTA MENTAL: DESDE EL INICIO HACER CADA COSA EN ARCHIVOS SEPARADOS
