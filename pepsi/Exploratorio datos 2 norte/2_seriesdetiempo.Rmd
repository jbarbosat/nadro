...
summary(datos$vta_din)
   Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    0.00    16.85    20.22    24.34    26.96 37970.00 
 
summary(datos$vta_uni)
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
    0.000     4.000     5.000     6.448     8.000 11270.000 

summary(datos$dev_din)
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
   0.0000    0.0000    0.0000    0.0543    0.0000 1266.0000 

summary(datos$dev_uni)
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
  0.00000   0.00000   0.00000   0.01428   0.00000 300.00000 
...
summary(datos$vta_din)
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    0.00    15.18    25.30    26.06    25.30 13410.00 

summary(datos$vta_uni)
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
   0.000    3.000    5.000    5.156    5.000 2650.000 

summary(datos$dev_din)
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
   0.0000    0.0000    0.0000    0.1264    0.0000 1356.0000 

summary(datos$dev_uni)
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
  0.00000   0.00000   0.00000   0.02508   0.00000 268.00000 
...
summary(datos$vta_din)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    0.0    23.6    29.5    43.5    47.2 49560.0 

summary(datos$vta_uni)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
   0.00    4.00    5.00    7.14    8.00 8400.00

summary(datos$dev_din)
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
   0.000    0.000    0.000    0.085    0.000 3516.000 

summary(datos$dev_uni)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  0.000   0.000   0.000   0.014   0.000 596.000 
