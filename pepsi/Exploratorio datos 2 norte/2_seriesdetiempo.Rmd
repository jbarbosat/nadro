...
x <- as.POSIXlt(datos$fecha)
datos$semana<-strftime(x,format="%W")
```

Para el análisis agregado que queremos, hay que promediar por semana y por tipo_cli 
...
agregados_fecha<-aggregate(datos,list(FactorA=datos$tipo_cli,FactorB=datos$fecha),sum)
